...
<head>
    ...
    <title>PKM Center - Pusat Kesehatan Masyarakat</title>
    ...
    <header id="header" class="header d-flex align-items-center position-relative">
        <div class="container-fluid container-xl position-relative d-flex align-items-center justify-content-between">
            ...
            <a href="{{ url('/') }}" class="logo d-flex align-items-center">
                ...
                <img src="{{ asset('assets/img/logo.png') }}" alt="PKM Center">
                <!-- <h1 class="sitename">PKM Center</h1>  -->
            </a>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6 mb-4 mb-lg-0">
                            <img src="{{ asset('assets/img/img_long_5.jpg') }}" alt="Image "
                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                <div class="service-item">
                                    ...
                                    <img src="{{ asset('assets/img/img_sq_8.jpg') }}" alt="Image"
                                        class="img-fluid">
                                </div>
                            </div>
                            ...
                            <div class="swiper-slide">
                                <div class="service-item">
                                    ...
                                    <img src="{{ asset('assets/img/img_sq_5.jpg') }}" alt="Image"
                                        class="img-fluid">
                                </div>
                            </div>
                            <div class="swiper-slide">
