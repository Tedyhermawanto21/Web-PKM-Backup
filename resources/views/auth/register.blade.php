...
<head>
    ...
    <title>Daftar - PKM Center UHAMKA</title>
        ...
        <div class="w-full lg:w-7/12 p-8 sm:p-12 lg:p-16 flex flex-col justify-center">
            <div class="max-w-md mx-auto w-full">
                ...
                <div class="text-left mb-10">
                    ...
                    <p class="text-slate-500">Silakan lengkapi data diri untuk mendaftar.</p>
                </div>
                ...
                <form class="space-y-6" method="POST" action="{{ route('register.process') }}">
                    @csrf
                    ...
                    <div>
                        ...
                        <div class="flex gap-4">
                            ...
                            <input type="text" name="nomor_induk" id="nomor_induk" required value="{{ old('nomor_induk') }}" class="w-2/3 px-4 py-3 rounded-xl border border-slate-200 focus:border-uhamka-700 focus:ring-4 focus:ring-uhamka-700/10 transition-all outline-none text-slate-900 placeholder-slate-400 font-medium" placeholder="Contoh: 12345678">
                        </div>
                    </div>

                    <div>
                        <label for="name" class="block text-sm font-bold text-slate-700 mb-2">Nama Lengkap</label>
                        <input type="text" name="name" id="name" required value="{{ old('name') }}" class="w-full px-4 py-3 rounded-xl border border-slate-200 focus:border-uhamka-700 focus:ring-4 focus:ring-uhamka-700/10 transition-all outline-none text-slate-900 placeholder-slate-400 font-medium" placeholder="Nama Lengkap Anda">
                    </div>

                    <div>
                        <label for="email" class="block text-sm font-bold text-slate-700 mb-2">Alamat Email</label>
                        <input type="email" name="email" id="email" required value="{{ old('email') }}" class="w-full px-4 py-3 rounded-xl border border-slate-200 focus:border-uhamka-700 focus:ring-4 focus:ring-uhamka-700/10 transition-all outline-none text-slate-900 placeholder-slate-400 font-medium" placeholder="nama@uhamka.ac.id">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="password" name="password_confirmation" id="password_confirmation" required class="w-full px-4 py-3 rounded-xl border border-slate-200 focus:border-uhamka-700 focus:ring-4 focus:ring-uhamka-700/10 transition-all outline-none text-slate-900 placeholder-slate-400 font-medium" placeholder="••••••••">
                    </div>
                    ...
                    <div class="space-y-4 pt-4">
                        ...
                        <div class="text-center text-sm text-slate-600">
                            Sudah punya akun? <a href="{{ route('login') }}" class="font-bold text-uhamka-700 hover:text-uhamka-900">Masuk disini</a>
                        </div>
