                    ...
                    <div class="space-y-6">
                        ...
                        <div class="flex flex-wrap gap-4">
                            ...
                            <div class="px-4 py-2 bg-slate-50 rounded-xl border border-slate-100">
                                ...
                                <span
                                    class="font-bold text-slate-700">{{ $proposal->dosenPembimbing->name ?? 'Belum ada' }}</span>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        @foreach ($proposal->anggota as $anggota)
                            <div
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-slate-500">{{ $anggota->nim }} • {{ $anggota->program_studi }}
                                    </p>
                                </div>
                            </div>
                        @endforeach
                ...
                <div class="p-6 space-y-6">
                    ...
                    <div>
                        ...
                        @if ($proposal->status_dosen == 'disetujui')
                            <div
                                class="flex items-center p-3 bg-green-50 rounded-xl border border-green-100 text-green-700">
                                <svg class="w-5 h-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        @else
                            <div
                                class="flex items-center p-3 bg-amber-50 rounded-xl border border-amber-100 text-amber-700">
                                <svg class="w-5 h-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <div>
                        ...
                        @else
                            <div
                                class="flex items-center p-3 bg-uhamka-50 rounded-xl border border-uhamka-100 text-uhamka-700">
                                <svg class="w-5 h-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                                </svg>
            ...
            @if ($proposal->status_kaprodi == 'menunggu' && $proposal->status_dosen == 'disetujui')
                <div class="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden">
                    ...
                    <div class="p-6 space-y-4">
                        <form action="{{ route('kaprodi.pengajuan_kelompok_pkm.approve', $proposal->id) }}"
                            method="POST">
                            @csrf
                            <div class="mb-4">
                                <label class="block text-xs font-bold text-slate-500 uppercase mb-2">Catatan Persetujuan
                                    (Opsional)</label>
                                <textarea name="catatan_kaprodi"
                    ...
                    <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                        <div class="sm:flex sm:items-start">
                            ...
                            <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                                ...
                                <div class="mt-2">
                                    <p class="text-sm text-slate-500 mb-4">Apakah Anda yakin ingin menolak proposal ini?
                                        Tindakan ini tidak dapat dibatalkan.</p>
                                    <label class="block text-sm font-bold text-slate-700 mb-2">Alasan Penolakan <span
                                            class="text-red-500">*</span></label>
                                    <textarea name="catatan_kaprodi"
                                        class="w-full rounded-xl border-slate-300 focus:border-red-500 focus:ring-red-500 shadow-sm" rows="3"
