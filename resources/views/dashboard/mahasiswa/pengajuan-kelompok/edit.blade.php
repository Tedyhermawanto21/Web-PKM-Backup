...
@section('content')
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden">
        ...
        <div class="p-8">
            <form action="{{ route('mahasiswa.pengajuan_kelompok_pkm.update', $proposal->id) }}" method="POST">
                @csrf
                @method('PUT')
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                required>{{ old('judul_kelompok', $proposal->judul_kelompok) }}</textarea>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <select
                                        ...
                                        <option value="PKM-KC"
                                            {{ old('skema', $proposal->skema) == 'PKM-KC' ? 'selected' : '' }}>PKM-KC (Karsa
                                            Cipta)</option>
                                        <option value="PKM-RE"
                                            {{ old('skema', $proposal->skema) == 'PKM-RE' ? 'selected' : '' }}>PKM-RE (Riset
                                            Eksakta)</option>
                                        <option value="PKM-GT"
                                            {{ old('skema', $proposal->skema) == 'PKM-GT' ? 'selected' : '' }}>PKM-GT
                                            (Gagasan Tertulis)</option>
                                        <option value="PKM-AI"
                                            {{ old('skema', $proposal->skema) == 'PKM-AI' ? 'selected' : '' }}>PKM-AI
                                            (Artikel Ilmiah)</option>
                                        <option value="PKM-PM"
                                            {{ old('skema', $proposal->skema) == 'PKM-PM' ? 'selected' : '' }}>PKM-PM
                                            (Pengabdian Masyarakat)</option>
                                        <option value="PKM-K"
                                            {{ old('skema', $proposal->skema) == 'PKM-K' ? 'selected' : '' }}>PKM-K
                                            (Kewirausahaan)</option>
                                        <option value="PKM-VGK"
                                            {{ old('skema', $proposal->skema) == 'PKM-VGK' ? 'selected' : '' }}>PKM-VGK
