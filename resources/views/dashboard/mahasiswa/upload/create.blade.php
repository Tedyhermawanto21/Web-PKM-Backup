...
<head>
    ...
    <title>Upload Proposal Baru - PKM Center</title>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            ...
                            @if ($proposals->count() > 0)
                                <form action="{{ route('mahasiswa.upload.store') }}" method="POST"
                                    enctype="multipart/form-data">
                                    @csrf

                                    <div class="form-group">
                                        <label for="proposal_id">Pilih Proposal <span
                                    ...
                                    <div class="form-group">
                                        <label for="file_proposal">File Proposal <span
                                                class="text-danger">*</span></label>
