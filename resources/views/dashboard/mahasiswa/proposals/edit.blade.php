...
<head>
    ...
    <title>Edit Proposal PKM - PKM Center</title>
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control @error('judul_kelompok') is-invalid @enderror" id="judul_kelompok"
                                            name="judul_kelompok" rows="3" placeholder="Masukkan judul lengkap proposal PKM Anda" required>{{ old('judul_kelompok', $proposal->judul_kelompok) }}</textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control @error('skema') is-invalid @enderror"
                                            ...
                                            <option value="PKM-KC"
                                                {{ old('skema', $proposal->skema) == 'PKM-KC' ? 'selected' : '' }}>
                                                PKM-KC (Karsa Cipta)</option>
                                            <option value="PKM-RE"
                                                {{ old('skema', $proposal->skema) == 'PKM-RE' ? 'selected' : '' }}>
                                                PKM-RE (Riset Eksakta)</option>
                                            <option value="PKM-GT"
                                                {{ old('skema', $proposal->skema) == 'PKM-GT' ? 'selected' : '' }}>
                                                PKM-GT (Gagasan Tertulis)</option>
                                            <option value="PKM-AI"
                                                {{ old('skema', $proposal->skema) == 'PKM-AI' ? 'selected' : '' }}>
                                                PKM-AI (Artikel Ilmiah)</option>
                                            <option value="PKM-PM"
                                                {{ old('skema', $proposal->skema) == 'PKM-PM' ? 'selected' : '' }}>
                                                PKM-PM (Pengabdian Masyarakat)</option>
                                            <option value="PKM-K"
                                                {{ old('skema', $proposal->skema) == 'PKM-K' ? 'selected' : '' }}>PKM-K
                                                (Kewirausahaan)</option>
                                            <option value="PKM-VGK"
                                                {{ old('skema', $proposal->skema) == 'PKM-VGK' ? 'selected' : '' }}>
