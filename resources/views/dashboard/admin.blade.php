...
@section('content')
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <!-- Card 1 -->
        <div
            class="bg-white p-5 rounded-2xl shadow-sm border border-slate-100 flex flex-col hover:shadow-md hover:border-uhamka-200 transition-all group">
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-slate-100 p-6">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            ...
            <a href="#"
                class="p-4 rounded-xl border border-slate-200 hover:border-uhamka-500 hover:bg-slate-50 transition-all flex flex-col items-center text-center gap-3 group">
                <div
                    class="w-10 h-10 rounded-full bg-slate-100 text-slate-600 flex items-center justify-center group-hover:bg-uhamka-500 group-hover:text-white transition-colors">
