...
@section('content')
    ...
    <div class="flex flex-col sm:flex-row items-center justify-between mb-8 gap-4">
        <div>
            <h1 class="text-2xl font-bold text-slate-800">Buat Akun Dosen</h1>
            <p class="text-slate-500">Tambahkan dosen baru ke dalam sistem.</p>
        </div>
                ...
                <div class="p-6">
                    <form action="{{ route('admin.dosens.store') }}" method="POST">
                        ...
                        <div class="mt-8 flex flex-col-reverse sm:flex-row gap-3">
                            <a href="{{ route('admin.dosens.index') }}" class="w-full sm:w-auto inline-flex justify-center items-center px-6 py-3 border border-slate-300 shadow-sm text-sm font-bold rounded-xl text-slate-700 bg-white hover:bg-slate-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-uhamka-500 transition-all">
                                 Batal
                            </a>
        ...
        <div class="lg:col-span-1 space-y-8">
            <div class="bg-blue-50 rounded-2xl p-6 border border-blue-100">
                ...
                <ul class="space-y-3 text-sm text-blue-800">
                    <li class="flex items-start gap-2">
                        ...
                        <span><strong>NIDN Unik:</strong> Pastikan NIDN yang dimasukkan belum terdaftar di sistem.</span>
                    </li>
                    <li class="flex items-start gap-2">
                        ...
                        <span><strong>Program Studi:</strong> Pilih program studi sesuai dengan homebase dosen.</span>
                    </li>
                </ul>
            </div>
            ...
            <div class="bg-amber-50 rounded-2xl p-6 border border-amber-100">
                ...
                <ul class="space-y-3 text-sm text-amber-800 list-disc ml-4">
                    <li>Gunakan password yang <strong>kuat</strong> (minimal 8 karakter).</li>
                    <li>Pastikan password dan konfirmasi password <strong>sama</strong>.</li>
                    <li>Akun ini akan memiliki hak akses sebagai <strong>Dosen</strong>.</li>
                </ul>
            </div>
        </div>
    </div>
