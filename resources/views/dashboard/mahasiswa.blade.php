...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
    ...
    <div class="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 hover:shadow-md hover:border-uhamka-200 transition-all group">
        <div class="flex items-start justify-between mb-4">
            ...
            <span class="px-3 py-1 bg-slate-50 text-slate-500 text-xs font-bold rounded-lg uppercase tracking-wider">Biodata</span>
        </div>
    ...
    <div class="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 hover:shadow-md hover:border-green-200 transition-all group">
        <div class="flex items-start justify-between mb-4">
            ...
            <span class="px-3 py-1 bg-green-50 text-green-600 text-xs font-bold rounded-lg uppercase tracking-wider">Tim</span>
        </div>
        ...
        <div class="mt-6">
            <button class="w-full inline-flex justify-center items-center py-2.5 px-4 border border-slate-200 rounded-xl shadow-sm text-sm font-bold text-slate-700 bg-white hover:bg-slate-50 focus:outline-none transition-all">
    ...
    <!-- Pengajuan Stats -->
    <div class="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 hover:shadow-md hover:border-uhamka-yellow-200 transition-all group relative overflow-hidden">
        <div class="absolute top-0 right-0 w-24 h-24 bg-uhamka-yellow-50 rounded-bl-full -mr-4 -mt-4 opacity-50"></div>
        
        <div class="flex items-start justify-between mb-4 relative z-10">
            <div class="w-12 h-12 bg-uhamka-yellow-50 rounded-xl flex items-center justify-center text-uhamka-yellow-600 text-xl group-hover:scale-110 transition-transform">
                📝
            </div>
            <span class="px-3 py-1 bg-uhamka-yellow-50 text-uhamka-yellow-700 text-xs font-bold rounded-lg uppercase tracking-wider">Proposal</span>
        </div>
        ...
        <div class="mt-6 relative z-10">
            <a href="{{ route('mahasiswa.proposals.create') }}" class="w-full inline-flex justify-center items-center py-2.5 px-4 border border-transparent rounded-xl shadow-md text-sm font-bold text-uhamka-900 bg-uhamka-yellow-400 hover:bg-uhamka-yellow-500 focus:outline-none transition-all">
...
<div class="bg-white rounded-2xl shadow-sm border border-slate-100 p-6">
    ...
    <p class="text-slate-600 leading-relaxed mb-4">Selamat datang di PKM Center. Sistem informasi manajemen Program Kreativitas Mahasiswa.</p>
