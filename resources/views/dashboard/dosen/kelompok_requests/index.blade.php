...
@section('title', 'Permintaan Pembimbing Kelompok')

@section('content')
    <div class="mb-8">
        <h1 class="text-2xl font-bold text-slate-800">Permintaan Pembimbing Kelompok</h1>
        <p class="text-slate-500">Daftar kelompok yang meminta Anda sebagai dosen pembimbing.</p>
    </div>
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden">
        <div class="p-6 border-b border-slate-100">
            <h3 class="font-bold text-lg text-slate-900">Daftar Permintaan</h3>
        </div>
                        ...
                        @foreach ($kelompoks as $index => $kelompok)
                            <tr class="hover:bg-slate-50 transition-colors">
                                ...
                                <td class="px-6 py-4 text-center">
                                    <a href="{{ route('dosen.kelompok_requests.show', $kelompok->id) }}"
        ...
        @else
            <div class="flex flex-col items-center justify-center py-12 text-slate-400">
                ...
                <p>Tidak ada permintaan pembimbing dari mahasiswa.</p>
            </div>
        @endif
    </div>
@endsection
